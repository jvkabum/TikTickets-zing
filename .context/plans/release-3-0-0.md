...
# Release 3.0.0 - TikTickets-zing Plan

> Atualizar o README.md com as novas funcionalidades e subir a versão do projeto para 3.0.0.
...
## Codebase Context
- **Total files analyzed:** 679
- **Total symbols discovered:** 683
...
- **Entry points:** backend\src\server.ts, backend\src\routes\index.ts, backend\src\database\index.ts (+9 more)

### Key Components
**Core Classes:**
- `MissingValueError` — C:\GitHub\TikTickets-zing\backend\src\utils\pupa.ts:59
- `RabbitmqServer` — C:\GitHub\TikTickets-zing\backend\src\libs\rabbitmq-server.ts:9
- `QueueListener` — C:\GitHub\TikTickets-zing\backend\src\libs\QueueListeners.ts:44
- `MissingValueError` — C:\GitHub\TikTickets-zing\backend\src\@types\pupa.d.ts:2
- `ClosePendingTicketsService` — C:\GitHub\TikTickets-zing\backend\src\services\SettingServices\ClosePendingTicketsService.ts:6

**Key Interfaces:**
- `GlobalComponents` — C:\GitHub\TikTickets-zing\frontend-vue-3\src\components.d.ts:13
- `Session` — C:\GitHub\TikTickets-zing\backend\src\types\WhatsAppSession.ts:7
- `Socket` — C:\GitHub\TikTickets-zing\backend\src\@types\socket.d.ts:6
- `Request` — C:\GitHub\TikTickets-zing\backend\src\@types\express.d.ts:5
- `Application` — C:\GitHub\TikTickets-zing\backend\src\@types\express.d.ts:21
## Agent Lineup
